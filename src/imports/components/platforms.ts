...
export class PlatformComponent {
  ...
  constructor(
    ...
    this.postionMove1 = this.startPosition.add(
      new Vector3(0, balanceDistance, 0)
    )
    this.postionMove2 = this.startPosition.add(
      new Vector3(0, balanceDistance * -1, 0)
    )
    ...
    this.movePath = new FollowPathMoveComponent(
      MovementType.Simple,
      [
        { position: this.startPosition, speed: -1, wait: 0 },
        { position: this.postionMove1, speed: -1, wait: 0 },
        { position: this.postionMove2, speed: -1, wait: 0 },
      ],
      this.entity,
      moveSpeed,
      false,
  ...
  reset() {
    this.stop()
    this.entity.getComponent(Transform).position = new Vector3(
  ...
  fall() {
    ...
    this.movePath.moveComponent.movement.targetLocation = new Vector3(
      this.startPosition.x,
      this.fallPointY,
      this.startPosition.z
    )
...
export class TriggeredPlatformComponent {
  ...
  constructor(
    ...
    this.movePath = new FollowPathMoveComponent(
      ...
      [
        { position: this.startPosition, speed: -1, wait: 0 },
        { position: this.endPosition, speed: -1, wait: 0 },
      ],
      this.entity,
      this.moveSpeed,
      false,
