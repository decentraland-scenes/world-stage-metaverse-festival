...
entity15670.getComponent(Transform).rotation.set(0.4082179, -0.2345697, 0.1093816, 0.8754261)
entity15670.getComponent(Transform).scale.set(1, 1, 1)

var entity15444 = new Entity("COG")
engine.addEntity(entity15444)
entity15444.addComponent(new Transform({ position: new Vector3(30.2, -0.09, 31.981) }))
...
entity15724.addComponent(new Transform({ position: new Vector3(28.53, 0.85, -20.46) }))
...
entity16372.addComponent(new Transform({ position: new Vector3(30.11, 1.34, 19.03) }))
...
entity16184.addComponent(new Transform({ position: new Vector3(-5.688088E-07, 2.505678E-08, 0) }))
...
entity16184.getComponent(Transform).rotation.set(0, 1, 0, -4.371139E-08)
...
entity15566.getComponent(Transform).rotation.set(0, 1, 0, -4.371139E-08)
var entity16280 = new Entity("flamingoV3_Art")
entity16280.setParent(entity15444)
entity16280.addComponent(new Transform({ position: new Vector3(30.47, 1.23, -26.05) }))
...
entity15960.addComponent(new Transform({ position: new Vector3(24.48336, 1.29, -25.37756) }))
...
entity16464.addComponent(new Transform({ position: new Vector3(24.67, 0, 22.66) }))
...
entity15318.addComponent(new Transform({ position: new Vector3(30.7, 1.25, 23.31) }))
...
entity15226.addComponent(new Transform({ position: new Vector3(-19.22, 3.91, -13.77) }))
...
entity15634.getComponent(Transform).rotation.set(0, 1, 0, -4.371139E-08)
var entity15868 = new Entity("flamingoV3_Art (6)")
entity15868.setParent(entity15444)
entity15868.addComponent(new Transform({ position: new Vector3(-19.44, 3.83, 13.56) }))
...
entity15496.addComponent(new Transform({ position: new Vector3(-18.76, 3.82, 10.99) }))
...
entity15782.addComponent(new Transform({ position: new Vector3(33.3, -0.04, -9.77) }))
entity15782.getComponent(Transform).rotation.set(6.125495E-17, 0.9999999, -6.125495E-17, 0.0003692826)
...
entity15782.getComponent(Transform).rotation.set(6.125495E-17, 0.0003692389, 6.125494E-17, -0.9999999)
var entity16078 = new Entity("AnimLightBulb_Art (1)")
entity16078.setParent(entity15444)
entity16078.addComponent(new Transform({ position: new Vector3(33.3, 0, 9.77) }))
entity16078.getComponent(Transform).rotation.set(6.125495E-17, 0.9999999, -6.125495E-17, 0.0003692826)
...
entity16078.getComponent(Transform).rotation.set(6.125495E-17, 0.0003692389, 6.125494E-17, -0.9999999)
var entity16020 = new Entity("PalmBuildingInterior_Art")
entity16020.setParent(entity15444)
entity16020.addComponent(new Transform({ position: new Vector3(2.067768, 7.7, 0.3176456) }))
...
entity15412.addComponent(new Transform({ position: new Vector3(0.946, 12.26, 43.632) }))
...
entity15412.addComponent(new Poap(entity15412, "MF2021_AroundTheWorld", false, null)) 
var entity16228 = new Entity("Palm")
entity16228.setParent(entity15444)
entity16228.addComponent(new Transform({ position: new Vector3(1.22, 2.81, -18.55) }))
...
entity15816.addComponent(new Transform({ position: new Vector3(0.9599984, 3.12, 23.35) }))
...
var entity16052 = new Entity("fire(30)")
entity16052.setParent(entity15444)
entity16052.addComponent(new Transform({ position: new Vector3(-17.831, 6.18, -7.31061) }))
entity16052.getComponent(Transform).rotation.set(0, -0.9955122, 0.09463346, 0)
entity16052.getComponent(Transform).scale.set(1.07975, 1.001554, 1.044023)
entity16052.addComponent(new GLTFShape("assets/glb_assets/FireWork.glb"))

var entity15030 = new Entity("flamingoV3_Art (7)")
entity15030.setParent(entity15444)
entity15030.addComponent(new Transform({ position: new Vector3(10.04, 1.21, 15.67) }))
...
entity15424.addComponent(new Transform({ position: new Vector3(1.07, 0.45, 24.68) }))
...
entity15370.addComponent(new Transform({ position: new Vector3(10.42, 1.0766, 18.84) }))
...
entity15122.addComponent(new Transform({ position: new Vector3(9.676878, 1.1713, 17.62519) }))
...
entity15174.addComponent(new Transform({ position: new Vector3(0.81, 2.81, -25.13) }))
...
var entity14970 = new Entity("fire (31)")
entity14970.setParent(entity15444)
entity14970.addComponent(new Transform({ position: new Vector3(-17.831, 6.18, 7.31061) }))
entity14970.getComponent(Transform).rotation.set(0, -0.9955125, -0.09462963, 0)
entity14970.getComponent(Transform).scale.set(1.07975, 1.001554, 1.044023)
entity14970.addComponent(new GLTFShape("assets/glb_assets/FireWork.glb"))

var entity16100 = new Entity("Torch_Art (2)")
entity16100.setParent(entity15444)
entity16100.addComponent(new Transform({ position: new Vector3(3.5, -0.68, -18.14) }))
...
entity16100.getComponent(Transform).rotation.set(0, 1, 0, -4.371139E-08)
var entity15804 = new Entity("Torch_Art (3)")
entity15804.setParent(entity15444)
entity15804.addComponent(new Transform({ position: new Vector3(4.6, -0.68, -23.85) }))
...
entity15804.getComponent(Transform).rotation.set(0, 1, 0, -4.371139E-08)
var entity16510 = new Entity("fire (32)")
entity16510.setParent(entity15444)
entity16510.addComponent(new Transform({ position: new Vector3(-20.41, 19.57, -18.15) }))
entity16510.getComponent(Transform).rotation.set(-0.1726969, -0.9794129, 0.1029404, -0.01815117)
entity16510.getComponent(Transform).scale.set(1.07975, 1.001554, 1.044023)
entity16510.addComponent(new GLTFShape("assets/glb_assets/FireWork.glb"))

var entity15430 = new Entity("fire (33)")
entity15430.setParent(entity15444)
entity15430.addComponent(new Transform({ position: new Vector3(-20.41, 19.57, 17.45) }))
entity15430.getComponent(Transform).rotation.set(-0.1726969, -0.9794129, -0.1029404, 0.01815116)
entity15430.getComponent(Transform).scale.set(1.07975, 1.001554, 1.044023)
entity15430.addComponent(new GLTFShape("assets/glb_assets/FireWork.glb"))

var entity14954 = new Entity("SecondaryStage")
entity14954.setParent(entity15444)
entity14954.addComponent(new Transform({ position: new Vector3(0, 0, 0) }))
entity14954.getComponent(Transform).rotation.set(0, 1, 0, 0)
entity14954.getComponent(Transform).scale.set(1, 1, 1)
entity14954.addComponent(new GLTFShape("assets/glb_assets/SecondaryStage.glb"))

var entity16038 = new Entity("SpotLights")
entity16038.setParent(entity15444)
entity16038.addComponent(new Transform({ position: new Vector3(0, 0, 0) }))
entity16038.getComponent(Transform).rotation.set(0, 1, 0, 0)
entity16038.getComponent(Transform).scale.set(1, 1, 1)
entity16038.addComponent(new GLTFShape("assets/glb_assets/SpotLights.glb"))
...
entity16576.getComponent(Transform).rotation.set(0, 1, 0, -4.371139E-08)
var entity16024 = new Entity("PlatesStage")
entity16024.setParent(entity15444)
entity16024.addComponent(new Transform({ position: new Vector3(0, -1.41, 0) }))
