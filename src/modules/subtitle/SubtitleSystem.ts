import type { NodeCue } from 'src/modules/subtitle/parser/index'
import { parseSync } from 'src/modules/subtitle/parser/index'
export type { NodeCue } from 'src/modules/subtitle/parser/index'
