...
entity59364n.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
...
entity52052.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
var entity52890 = new Entity('flamingoV3_Art')
entity52890.setParent(entity51930)
entity52890.addComponent(
...
entity52746.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
var entity51898 = new Entity('PoapMachine_Art')
entity51898.setParent(entity51930)
entity51898.addComponent(
...
entity51898.addComponent(
  new Poap(entity51898, 'MusicFestival2021', false, null)
)
var entity52838 = new Entity('Palm')
entity52838.setParent(entity51930)
entity52838.addComponent(
...
entity51910.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
var entity51860 = new Entity('Torch_Art (1)')
entity51860.setParent(entity51930)
entity51860.addComponent(
...
entity51860.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
var entity51610 = new Entity('flamingoV1_Art (2)')
entity51610.setParent(entity51930)
entity51610.addComponent(
...
entity52826.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
var entity52218 = new Entity('Torch_Art (3)')
entity52218.setParent(entity51930)
entity52218.addComponent(
...
entity52218.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
...
entity53186.getComponent(Transform).rotation.set(0, 1, 0, -4.371139e-8)
